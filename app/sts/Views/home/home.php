...
if (!empty($this->data['home']['top'][0])) {
    ...
    //A fun ção extract é utilizado para extrair o array e imprimir atráves do nome da chave
    extract($this->data['home']['top'][0]);
?>

    <section class="top" style="background: linear-gradient(to right, var(--main-color) 25%, rgba(255, 255, 255, 0)), url('<?php echo URL; ?>app/sts/assets/images/home_top/<?php echo $image_top ?>'); background-size: cover; background-attachment: fixed; ">
        <div class="max-width">
...
<?php
    ...
    echo "<p style='color: #F00;'>Erro: Nenhum serviço do top encontado!</p>";
}

//Testar o acesso ao arquivo
//http://localhost/cursos/php/site/app/sts/Views/home/home.php

//Testar o acesso ao arquivo
//http://localhost/cursos/php/site/app/sts
...
<?php
    ...
    echo "<p style='color: #F00;'>Erro: Nenhum serviço encontado!</p>";
}
...
<?php
    ...
    echo "<p style='color: #F00;'>Erro: Nenhum serviço premium encontado!</p>";
}
...
<?php
    ...
    echo "<p style='color: #F00;'>Erro: Nenhum rodapé encontado!</p>";
}
